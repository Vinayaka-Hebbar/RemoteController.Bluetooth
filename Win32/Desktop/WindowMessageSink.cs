...
namespace RemoteController.Win32.Desktop
{
    ...
    public class WindowMessageSink : IDisposable
    {
        ...
        private void CreateMessageWindow()
        {
            ...
            Interop.RegisterClass(ref wc);

            // Get the message used to indicate the taskbar has been restarted
            // This is used to re-add icons when the taskbar restarts
            taskbarRestartMessageId = Interop.RegisterWindowMessage("TaskbarCreated");

            // Create the message window
            MessageWindowHandle = Interop.CreateWindowEx(0, WindowId, "", 0, 0, 0, 1, 1, IntPtr.Zero, IntPtr.Zero,
        ...
        private IntPtr OnWindowMessageReceived(IntPtr hWnd, uint messageId, IntPtr wParam, IntPtr lParam)
        {
            ...
            return Interop.DefWindowProc(hWnd, messageId, wParam, lParam);
        }
        ...
        private void Dispose(bool disposing)
        {
            ...
            Interop.DestroyWindow(MessageWindowHandle);
            messageHandler = null;
        }
