...
namespace RemoteController.Win32.Hooks
{
    public abstract class GlobalHookBase : IGlobalHook
    {
        ...
        public abstract IList<Display> GetDisplays();
        ...
        protected void OnKeyDown(Key key)
        {
            ...
            KeyboardKeyEventArgs e = KeyDownArgs;
        ...
        {
            KeyPressEventArgs e = KeyPressArgs;
            e.KeyChar = c;
            KeyPress(this, e);
        }
        ...
        protected void OnKeyUp(Key key)
        {
            ...
            KeyboardKeyEventArgs e = KeyUpArgs;
            e.Keyboard = KeyboardState;
            e.Key = key;
            e.Handled = false;
        ...
        {
            ClipboardChangedEventArgs e = ClipboardChangedEventArgs;
            e.Value = value;
            Clipboard(this, e);
        }
        ...
        protected void OnMouseDown(MouseButton button)
        {
            ...
            MouseButtonEventArgs e = MouseDownArgs;
            e.Button = button;
            e.IsPressed = true;
            e.Mouse = MouseState;
            e.Handled = false;
        ...
        protected void OnMouseUp(MouseButton button)
        {
            ...
            MouseButtonEventArgs e = MouseUpArgs;
            e.Button = button;
            e.IsPressed = false;
            e.Mouse = MouseState;
            e.Handled = false;
        ...
        protected void OnMouseMove(int x, int y)
        {
            ...
            MouseMoveEventArgs e = MouseMoveArgs;
            e.Mouse = MouseState;
            e.Handled = false;
