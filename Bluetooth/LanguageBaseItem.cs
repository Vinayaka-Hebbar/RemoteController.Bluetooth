...
namespace RemoteController.Bluetooth
{
    ...
    public sealed class LanguageBaseItem
    {
        ...
        /// </summary>
        public const short PrimaryLanguageBaseAttributeId = 0x0100;
        ...
        private readonly ushort m_baseAttrId;
        ...
        public LanguageBaseItem(short naturalLanguage, short encodingId, short baseAttributeId)
            : this(unchecked((ushort)naturalLanguage), unchecked((ushort)encodingId), unchecked((ushort)baseAttributeId))
        { }
        ...
        /// e.g. 0x100 for the Primary language.
        /// </param>
        public LanguageBaseItem(string naturalLanguage, ushort encodingId, ushort baseAttributeId)
        ...
        /// e.g. 0x100 for the Primary language.
        /// </param>
        public LanguageBaseItem(string naturalLanguage, short encodingId, short baseAttributeId)
            : this(GetLanguageIdStringAsBytes(naturalLanguage), unchecked((ushort)encodingId), unchecked((ushort)baseAttributeId))
        { }
        ...
        public static ServiceElement CreateElementSequenceFromList(LanguageBaseItem[] list)
        {
            ...
            foreach (LanguageBaseItem item in list)
            {
                ...
                ushort langNumerical = item.NaturalLanguageId;
                children.Add(new ServiceElement(ElementType.UInt16,
                    langNumerical));
                children.Add(new ServiceElement(ElementType.UInt16,
                    item.EncodingId));
                children.Add(new ServiceElement(ElementType.UInt16,
                    item.AttributeIdBase));
            }
        ...
        public ushort NaturalLanguageId { get { return m_naturalLanguage; } }


        /// <summary>
        /// Gets the base Attribute Id for this language.
        /// </summary>
        public ushort AttributeIdBase { get { return m_baseAttrId; } }
        ...
        private struct IetfCharsetIdToDotNetEncodingNameMap
        {
            ...
            {
                IetfCharsetId = ietfCharsetId_;
                DotNetEncodingName = DotNetEncodingName_;
            }
        }
