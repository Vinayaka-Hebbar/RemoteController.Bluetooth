...
namespace RemoteController.Bluetooth
{
    ...
    public class ServiceRecordBuilder
    {
        ...
        private IList<ServiceAttribute> m_customList = new List<ServiceAttribute>();
        ...
        public ServiceRecord ServiceRecord
        {
            get
            {
                ...
                // -- ClassIDs --
                attrList.Add(new ServiceAttribute(AttributeIds.ServiceClassIdList,
                ...
                if (pdl != null)
                    attrList.Add(new ServiceAttribute(AttributeIds.ProtocolDescriptorList, pdl));
                // -- Strings --
                if (m_ServiceName != null)
                {
                    attrList.Add(new ServiceAttribute(
                        AttributeIds.ServiceName
                ...
                {
                    attrList.Add(new ServiceAttribute(
                        AttributeIds.ServiceDescription
                            + LanguageBaseItem.PrimaryLanguageBaseAttributeId,
                ...
                if (needsLangBaseId)
                {
                    attrList.Add(new ServiceAttribute(AttributeIds.LanguageBaseAttributeIdList,
                    ...
                    foreach (BtPdlItem cur in m_profileDescrs)
                    {
                        ServiceElement item = new ServiceElement(ElementType.ElementSequence,
                            ...
                            new ServiceElement(ElementType.UInt16,
                                (ushort)(cur.m_version * 256 + cur.m_subVersion)));
                        items.Add(item);
                    }//for
                    attrList.Add(new ServiceAttribute(
                        AttributeIds.BluetoothProfileDescriptorList,
                        new ServiceElement(ElementType.ElementSequence,
...
#warning Hey Hey Hey Hey Hey Hey Hey Hey Hey Hey
        ...
        /// </param>
        private static void ReportIfDuplicates(IList<ServiceAttribute> list, bool storedList)
        {
            Dictionary<ushort, ServiceAttribute> ids
                            = new Dictionary<ushort, ServiceAttribute>(list.Count);
        ...
        private IList<ServiceElement> BuildServiceClassIdList()
        {
